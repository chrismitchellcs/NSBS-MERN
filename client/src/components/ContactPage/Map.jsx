const MapBox = () => {
  return (
    <div className="flex w-full flex-col">
      <div className="relative w-full overflow-hidden rounded-3xl border border-white/10 bg-slate-900/40 shadow-2xl">
        <div className="relative w-full pb-[80%] sm:pb-[60%] lg:pb-[45%]">
          <iframe
            title="North Shore Bike Shop location"
